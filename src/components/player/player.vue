  ...
  <div class="player" v-show="playlist.length>0 && currentSong">
    ...
    >
      <div class="normal-player" v-show="fullScreen">
        <div class="background">
          <img width="100%" height="100%" :src="currentSong.image+imageSize" v-show="currentSong.image">
        </div>
        <div class="top">
          ...
          <div class="middle-l" ref="middleL">
            <div class="cd-wrapper" ref="cdWrapper">
              <div class="cd" :class="cdCls">
                <img class="image" :src="currentSong.image+imageSize" v-show="currentSong.image">
              </div>
            </div>
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <img :class="cdCls" width="40" height="40" :src="currentSong.image+imageSizeIcon" v-show="currentSong.image">
        </div>
        <div class="text">
  ...
  export default {
    ...
    data() {
      return {
        ...
        currentShow: 'cd',
        playingLyric: '',
        imageSize:"?param=600y600",
        imageSizeIcon:"?param=40y40"
      }
    },
    computed: {
      cdCls() {
    ...
    methods: {
      ...
      getSingers(singerArr){
        if(singerArr.length>0){
          let singer="";
          singerArr.map((v,i)=>{
            if(singerArr.length>1 && i>0){
              singer+=" - "
            }
            singer+=v.name;
          })
